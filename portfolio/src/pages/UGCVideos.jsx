...
const aiVideos = [
  {
    ...
    type: "AI UGC",
    cloudName: "dobulag2p",
    publicId: "Ai_ugc_10_ygvpdh",
  },
  {
    title: "AI UGC — 2",
    type: "AI UGC",
    cloudName: "dobulag2p",
    publicId: "ai_ugc_9_ovpev5",
  },
  {
...
const irlVideos = [
  {
    title: "PREMIUM REAL SHOOT 1",
    type: "IRL",
    cloudName: "dobulag2p",
    publicId: "7_lpgoxu",
  },
  {
    title: "PREMIUM REAL SHOOT 2",
    type: "IRL",
    cloudName: "dobulag2p",
    publicId: "8_l0wsbr",
  },
          ...
          >
            {irlVideos.map((v, i) => (
              <motion.div
                key={i}
                className="ugc-card"
                style={{ aspectRatio: '9/16', overflow: 'hidden', position: 'relative', borderRadius: '32px', background: '#111', boxShadow: '0 8px 48px rgba(0,0,0,0.5)' }}
